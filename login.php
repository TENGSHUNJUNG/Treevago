            ...
            <div class="member-box">
                <form name="form1"  method="post" onsubmit="return checkForm()">
                    ...
                    <div class="form-group input-box">
                        ...
                        <small id="emailHelp" class="form-text">請填帳號:</small>
                    </div>
                    <div class="form-group input-box">
                        ...
                        <small id="passwordHelp" class="form-text">請填密碼</small>
                    </div>



                    <div class="btn-control">
                        <button type="submit" class="btn_enter">登入</button>
                        <button class="btn_enter"><a href="register.php">註冊</a></button>
                    </div>
